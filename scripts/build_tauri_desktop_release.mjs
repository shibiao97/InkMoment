...
const pythonScript = join(root, "scripts", "build_tauri_desktop_release.py");
...
console.error(`Unable to start Python for legacy Tauri desktop release build: ${lastError?.message || "not found"}`);
process.exit(1);
